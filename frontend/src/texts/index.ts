...
function load() {
  return {
    common: {
      ...
      publicDescription: translate('common.publicDescription'),
      privateDescription: translate('common.privateDescription'),
    ...
    chat: {
      ...
      prompts: {
        ...
        labels: {
          ...
          visibility: translate('chat.prompts.labels.visibility'),
