...
class CodeProvider(AbstractFormatProvider):
    ...
    def __init__(self, chunk_size: int = 4000, chunk_overlap: int = 200, **_kwargs):
        super().__init__()
        self.default_chunk_size = chunk_size
        self.default_chunk_overlap = chunk_overlap

    def splitter(self, language: Language | None, chunk_size: int | None = None, chunk_overlap: int | None = None):
        if language is None:
