...
export class SummaryPromptExtension implements Extension<SummaryPromptExtensionConfiguration> {
  ...
  get spec(): ExtensionSpec {
    return {
      name: 'summary-prompt',
      title: this.i18n.t('texts.extensions.summaryPrompt.title'),
      ...
      description: this.i18n.t('texts.extensions.summaryPrompt.description'),
      type: 'other',
      arguments: {
        prompt: {
          type: 'string',
          title: this.i18n.t('texts.extensions.common.prompt'),
          format: 'textarea',
          description: this.i18n.t('texts.extensions.summaryPrompt.promptHint'),
          required: true,
        },
        historySize: {
          type: 'number',
          title: this.i18n.t('texts.extensions.common.historySize'),
          required: true,
        },
      },
    };
...
type SummaryPromptExtensionConfiguration = ExtensionConfiguration & {
  prompt: string;
